/*
Para doar sangue é necessário ter entre 18 e 67 anos e possuir mais de 60Kg. Faça um aplicativo que 
pergunte a idade de uma pessoa e seu peso e diga se ela pode doar sangue ou não, caso não diga o(s) motivo(s).
Nome:Dandara
*/
...
if (idade >= 18 && idade <= 67){
  if (peso >= 60){
    console.log(`Você podera doar sangue, vá para sala Azul, ao final do corredor e ajude 
    mais uma pessoa necessitada`);
  }
  else{
